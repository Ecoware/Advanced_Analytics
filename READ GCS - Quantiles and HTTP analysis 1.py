...
## Before this first sql is run it is necessary to create the ext_list below
...
sql_query_eg_5tuple = "Select dstAd, count(dstAd) as dstAd_count from ipfix_5_min group by dstAd order by dstAd_count desc"


raw_161_eg_5t = lab.fetch('ipfix_5_min',['2018-03-19T09:00:00','2018-03-19T09:01:00'],'',0,sql_query_eg_5tuple,'L')
...
#sample = raw_161_eg_5t.sample(frac=0.75, replace=True)
sample = raw_161_eg_5t.sample(frac=1.00, replace=True)
#sample2 = raw_161_eg_5t.sample(frac=0.5, replace=True)
...
#raw_ext = (raw_161_eg_5t.loc[(raw_161_eg_5t['dstAd'].isin([ext_list]))])
## This works however 
raw_ext = (raw_161_eg_5t.loc[(raw_161_eg_5t['dstAd'].isin(['52.48.97.225']))])
raw_ext.to_csv('/Users/swe03/raw_ext.csv', index=False)
#raw_ext.info()
#%%
...
view_raw2 = pdsql("""Select * from raw_161_eg_5t 
