...
def get_recs_w_date_range(date_s,date_e):
    ...
    query = """SELECT Timestamp, dst_addr,
               ...
               LIMIT 100 """.format(date_s,date_e)
    #print('The value of local var date_s is: {}'.format(date_s))
    #print('The value of local var date_e is: {}'.format(date_e))
    dfx1 = pd.read_gbq(query, project_id="network-sec-analytics",private_key="/home/swe03/service_account.json")
...
def write_to_gbq():
  bytes_dist.to_gbq('prod.ts_port_53_4wks', "network-sec-analytics", verbose=True, reauth=False, 
   if_exists='replace', private_key="/home/swe03/service_account.json")
  return
write_to_gbq()
