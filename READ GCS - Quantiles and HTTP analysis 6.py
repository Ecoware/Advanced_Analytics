...
raw_161_eg_5t = lab.fetch('ipfix_5_min',['2018-03-19T09:00:00','2018-03-19T09:10:00'],'',0,sql_query_eg_5tuple,'L')
...
def ReadFromGCS():
    ...
    blob.download_to_filename('/home/steve/Data/RawData/raw_161_eg_5t')
    
    
    ## Read a local file into a Dataframe
    raw_161_eg_5t = pd.DataFrame() 
    raw_161_eg_5t = pd.read_csv('/home/steve/Data/RawData/raw_161_eg_5t',sep=',')  
    raw_161_eg_5t.info()
    return()
